...
<a data-icon="home" data-role="button" href="javascript:void(0)" onclick="window.history.go(-1);swithDiv(3);" data-theme="a"><span>返回</span></a>
