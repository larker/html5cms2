			...
			<table class="listTable">
				<tr>
					...
					<#if (adminDepartment == true)!>
						<th>
							<span class="sort" name="departmentId">组织单位</span>
						</th>
					</#if>
					<th>
						<span class="sort" name="productCategory">商品分类</span>
					</th>
					<th>
					...
					<th>
						<span class="sort" name="isBest">首页推荐</span>
					</th>
					<th>
						<span class="sort" name="point">排序</span>
					</th>
					<th>
						操作
					</th>
				...
				<#list pager.list as list>
					<tr>
						...
						<#if (adminDepartment == true)!>
						<td>
							<#if (list.departmentId?length > 0)!>
							<a href="organise!edit.action?id=${list.departmentId}" title="编辑">${list.department}</a>
							</#if>
						</td>
						</#if>
						<td>
