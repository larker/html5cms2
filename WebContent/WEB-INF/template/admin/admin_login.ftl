...
<body class="login">
	<div class="body">
		            ...
		            <table class="loginTable">
		                ...
		                <tr>
		                    ...
		                    <td>
		                        ...
		                        <input type="button" class="helpButton ignoreForm" value="帮 助" onclick="window.open('http://help.larkersos.com')" hidefocus="true" />
		                    </td>
		                </tr>
		            </table>
		        </form>
		...
		<div class="footer">
			<a href="${base}/">前台首页</a>|
			<a href="http://www.larkersos.com">官方网站</a>|
			<a href="http://bbs.larkersos.com">官方论坛</a>|
			<a href="http://about.larkersos.com">关于我们</a>|
			<a href="http://contact.larkersos.com">联系我们</a>|
			<a href="http://certificate.larkersos.com">授权查询</a>
		</div>
	</div>
</body>
</html>