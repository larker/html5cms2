...
<title>单位列表 - Powered By ${systemConfig.systemName}</title>
...
<body class="list">
	<div class="body">
		...
		<form id="listForm" action="organise!list.action" method="post">
			<div class="operateBar">
				<input type="button" class="addButton" onclick="location.href='organise!add.action'" value="添加" />
				<label>查找:</label>
			...
			<table class="listTable">
				...
				<#list pager.list as list>
					<tr>
						...
						<td>
							<a href="organise!edit.action?id=${list.id}" title="编辑">[编辑]</a>
			...
			<#if (pager.list?size > 0)>
				<div class="pagerBar">
					<input type="button" class="deleteButton" url="organise!delete.action" value="删 除" disabled hidefocus="true" />
