...
public class Product extends BaseEntity {
	...
	public static final int MAX_HOT_PRODUCT_LIST_COUNT = 5;// 热销商品列表最大商品数
	public static final int DEFAULT_PRODUCT_LIST_PAGE_SIZE = 12;// 商品列表默认每页显示数
	
	private String productSn;// 货号/推荐序号 排序用
	private String name;// 商品名称
	private BigDecimal price=BigDecimal.ZERO;// 商品价格
	private BigDecimal marketPrice=BigDecimal.ZERO;// 市场价格
	private Double weight=BigDecimal.ZERO.doubleValue();// 商品重量
	private WeightUnit weightUnit=WeightUnit.kg;// 重量单位
	...
	private String department;// 组织部门ming
